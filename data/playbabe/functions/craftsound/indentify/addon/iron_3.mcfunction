...
execute if predicate playbabe:craftsound/addon_x2/iron_3 run function playbabe:craftsound/sounds/large_filter/iron_3
execute if entity @s[tag=pbbs.cs.processing] run scoreboard players set @s pbbs.cs.sound.10 1
function playbabe:craftsound/reset_score/addon/iron_3
