...
execute if predicate playbabe:craftsound/addon_x2/page_1 run function playbabe:craftsound/sounds/large_filter/page_1
execute if entity @s[tag=pbbs.cs.processing] run scoreboard players set @s pbbs.cs.sound.11 1
function playbabe:craftsound/reset_score/addon/page_1
